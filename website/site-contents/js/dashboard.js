...
(function() {
  ...
  Dashboard.Map = function(L) {
    ...
    const mapBoxEndpoint = 'https://api.mapbox.com/styles/v1/mapbox/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}';
  ...
  $(window).on('load', function() {
    ...
    $('form').on('submit', function(e) {
      ...
      kinesis.listStreams().promise()
        ...
        .then(() => Cookies.set("kinesisStreamName", kinesisStreamName))
